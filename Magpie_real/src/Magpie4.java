...
public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "won") >= 0) {
	...
	//my code
	public String transformIYouStatement(String statment) {
		statment = statment.toLowerCase().trim();
		statment = statment.substring(statment.indexOf("i")+2, statment.indexOf("you")-1);
		return "Why do you " + statment  + " me?";
	}
